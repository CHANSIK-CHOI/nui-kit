...
const SCALES: [string, string][] = [
  ...
  [
    "secondary",
    "보조 색 — 브랜드와 같은 색조, 채도 절반. 덜 중요한 액션과 구분용 면",
  ],
...
.my-tooltip {
  ...
  color: #fff;
      ...
      <p>
        ...
        대 1 을 넘는 글자색이다. <code>-hover</code> 와 <code>-active</code> 는
        같은 색조의 다음 단계다. 누르는 순간 색이 한 단계씩 진해지고, 그림자나
      ...
      <p>
        ...
        입력 테두리는 9번, 채워진 배경도 9번, hover 는 10번이다. 테두리를 9번에
        두는 이유는 배경과 3 대 1 이 넘어야 저시력 사용자에게도 보이기 때문이다.
      </p>
      <ScaleLegend />
