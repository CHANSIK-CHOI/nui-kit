...
export function SelectDemo() {
  ...
  return (
    <>
      ...
      <Example row={false} caption="선택한 값이 그대로 상태에 들어간다">
        <Select
          options={CITIES}
          value={city}
      ...
      <Example row={false} caption="isSearchable + isClearable">
        <Select
          options={CITIES}
          value={searchable}
      ...
      <h2>옵션 그룹</h2>
      <Example row={false} caption="options 에 { label, options } 를 넣는다">
        <Select
          options={GROUPED}
          value={grouped}
      ...
      <Example row={false} caption="값이 원시값 배열로 들어온다">
        <MultiSelect
          options={CITIES}
          value={cities}
      ...
      <Example row={false} caption="disabled">
        <Select options={CITIES} value="seoul" disabled />
      </Example>
      <Example row={false} caption="readOnly — 열리지 않는다">
      ...
      <Example row={false} caption="infoMessage">
        <Select
          options={CITIES}
          value={null}
