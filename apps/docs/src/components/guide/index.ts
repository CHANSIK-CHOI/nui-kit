 ...
 *
 * 문장 층은 `ExceptionBadges`(공통 규칙 예외를 가리킨다)와
 * `DesignNote`(설계 근거를 접는다)가 만든다 — 문서 문장 규칙(docs-voice).
 */
...
export { ExceptionBadges } from "./ExceptionBadge";
export type { ExceptionKind } from "./ExceptionBadge";
export { DesignNote } from "./DesignNote";
